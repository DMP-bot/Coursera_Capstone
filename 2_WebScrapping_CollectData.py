"""
Created on Fri Dec 23 10:22:19 2022
"""
...
# To keep the lab tasks consistent, you will be asked to scrape the data from 
# a snapshot of the List of Falcon 9 and Falcon Heavy launches Wikipage updated on 9th June 2021
...
# to extract column name one by one.  Apply find_all() function with `th` element on first_launch_table
